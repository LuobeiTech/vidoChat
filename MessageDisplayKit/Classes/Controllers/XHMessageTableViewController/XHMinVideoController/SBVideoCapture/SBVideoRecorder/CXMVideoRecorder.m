...
#import "CXMVideoRecorder.h"
#import "SBCaptureDefine.h"
#import "SBCaptureToolKit.h"

@interface CXMVideoData: NSObject
...
@implementation CXMVideoData

@end

#define COUNT_DUR_TIMER_INTERVAL 0.05

@interface CXMVideoRecorder ()
...
@implementation CXMVideoRecorder
...
- (void)mergeVideoFiles
{
    ...
    for (CXMVideoData *data in _videoFileDataArray) {
...
- (void)deleteLastVideo
{
    ...
    CXMVideoData *data = (CXMVideoData *)[_videoFileDataArray lastObject];
...
- (void)captureOutput:(AVCaptureFileOutput *)captureOutput didFinishRecordingToOutputFileAtURL:(NSURL *)outputFileURL fromConnections:(NSArray *)connections error:(NSError *)error
{
    ...
    if (!error) {
        CXMVideoData *data = [[CXMVideoData alloc] init];
